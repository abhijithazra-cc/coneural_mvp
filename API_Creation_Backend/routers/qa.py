...
# # Call OpenAI with wrapped prompt
...
#         "Answer the question ONLY using the provided snippets. "
#         "Write in clear, natural language — avoid technical jargon unless needed. "
#         "Rephrase so it doesn’t sound like AI output. "
#         "If relevant, include a short example or illustration. "
...
#         return (
#             f"(Demo mode) No OpenAI key configured.\n"
#             f"Based on {len(snippets)} snippets, here’s a synthesized answer:\n\n"
#             + "\n---\n".join(snippets[:2])
#         )
...
#     top = scored[:top_k]
#     snippets = [c[:1500] for _, __, c in top]   # trim length
...
#             sources=[],
#             answer="I couldn’t find relevant content in your allowed domains.",
#         )
